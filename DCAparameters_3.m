function [h,familycouplings,align]=DCAparameters_3(inputfile,stype)
% Direct Coupling Analysis (DCA) Scapes - parameters estimation
% couplings and local fields parameters estimation, where all the couplings and fields measured relative to nucleotide G were set to 0
%
