function [h,familycouplings,align]=DCAparameters_2(inputfile,stype)
% Direct Coupling Analysis (DCA) Scapes - parameters estimation
% couplings and local fields parameters estimation, where all the couplings and fields measured relative to nucleotide C were set to 0
%
