function [h,familycouplings,align]=DCAparameters_4(inputfile,stype)
% Direct Coupling Analysis (DCA) Scapes - parameters estimation
% couplings and local fields parameters estimation, where all the couplings and fields measured relative to nucleotide T/U were set to 0
%
...
%
% This software and accomapnying documents are implementated based on the 2011 DCA paper(F Morcos, A Pagnani & B Lunt et al, 2011 )
% Copyright for this implementation: 
%
%             2018/4  - Qin Zhou and José Alberto De la Paz
